...
ARM_LENGTH_CM = 30
CAPTURE_DELAY_S = 5
OUTPUT_IMAGE_PATH = 'output/processed_frame.jpg'
...
def main():
    ...
    try:
        ...
        logger.debug("Preparing to save output image.")
        processed_image = grid_mapper.draw_grid(balanced_frame.copy())
        ...
        logger.info(f"Processed image with detections saved to {OUTPUT_IMAGE_PATH}")
